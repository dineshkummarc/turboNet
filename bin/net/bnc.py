...
try:
	...
	if debug:
		print('common parser 1st import to bnc failed',err,sep="->",end="\n")
	try:
		from battleNet.net import common
	except ImportError as err:
		if debug:
			print('common parser 2nd import to bnc failed',err,sep="->",end="\n")
...
def battle_CS_50(packedMessage):
	...
	if debug:
		print('format',pck_format,'for bytes',packedMessage,sep=" ::: ",end="\n")
	unpackedMessage=common.unpackMessage_2(modelForm=pck_format,packedData=packedMessage)
