...
delete B.OnReady.timer;B.OnReady.onload();}},10);}else{if(document.addEventListener){if(SR_url.indexOf('code.msdn.microsoft.com') != -1 || SR_url.indexOf('gallery.msdn.microsoft.com') != -1 || SR_url.indexOf('gallery.technet.microsoft.com') != -1 || SR_url.indexOf('visualstudiogallery.msdn.microsoft.com') != -1){B.OnReady.onload();}else{document.addEventListener("DOMContentLoaded",B.OnReady.onload,false);}
